...
10 & Name & Email & Pwd & SecQ & SecA & 10; ./TEXT/1/|./TEXT/2/; ./IMAGE/1/|./IMAGE/2/; name1|name2 & Lastlogin
...
func (m *MD_User) Scan(val interface{}) error {
	...
	(*m).His_Cre.Names = strings.Split(sss[3], "|")
...
func (m MD_User) Value() (driver.Value, error) {
	...
	str_3 := strconv.Itoa(m.His_Cre.User_Id) + ";" + strings.Join(m.His_Cre.Text_path, "|") + ";" + strings.Join(m.His_Cre.Img_path, "|") + ";" + strings.Join(m.His_Cre.Names, "|")
